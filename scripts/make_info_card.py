...
# ===========================================================================
HOST = "samaksh"   # shown as  samaksh@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Full-Stack Developer"),
    ("kv", "Focus", "Production-deployed apps"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, TypeScript"),
    ("kv", "Backend", "Node.js, PostgreSQL"),
    ("kv", "Lang", "JavaScript / TypeScript"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "quickfix-client -- real-time automotive marketplace (MERN)"),
    ("bul", "health-monitor"),
    ("bul", "devTinder + my-portfolio"),
    ("bul", "ResQNet"),
]
